 ...
 * Description: Program to demonstrate the task switching depending on the priorities.
		And the usage of vTaskSuspendAll() and vTaskResumeAll() functions
...
static void MyTask1(void* pvParameters)
{
  ...
  Serial0.printf("\n\rIn Task1, Suspending all tasks");
  vTaskSuspendAll();
...
static void MyTask4(void* pvParameters)
{
  ...
  Serial0.printf("\n\rIn Task4, Suspending all tasks 2,3 and 4");
